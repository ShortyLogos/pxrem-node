...
const ExampleComponent = () => {
  return (
    <div className="bg-blue-500 px-[45px] rounded-lg">
      ...
      <ul className="list-disc ml-8">
        <li className="mb-2">
          Width: <span className="font-bold text-blue-900">w-[500px]</span>
        </li>
        <li className="mb-2">
          Padding: <span className="font-bold text-blue-900">%%% 32px $$$</span>
        </li>
        <li className="mb-2">
          Margin: <span className="font-bold text-blue-900">m-[16px]</span>
        </li>
        <li className="mb-2">
